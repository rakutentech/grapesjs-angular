...
declare namespace grapesjs {
  interface Editor {
    ...
    selectAdd(el: object | HTMLElement | Array<object> | Array<HTMLElement>): Editor;
    selectRemove(el: object | HTMLElement | Array<object> | Array<HTMLElement>): Editor;
    selectToggle(el: object | HTMLElement | Array<object> | Array<HTMLElement>): Editor;
  ...
  type BlockEvent = 'block:add' | 'block:remove' | 'block:drag:start' | 'block:drag' | 'block:drag:stop';
  ...
  type StyleManagerEvent = 'styleManager:update:target' | 'styleManager:change' | 'styleManager:change:{propertyName}';
  ...
  type CanvasEvent = 'canvas:dragenter' | 'canvas:dragover' | 'canvas:drop' | 'canvas:dragend' | 'canvas:dragdata';
  ...
  interface StorageManager {
    get(src: string): StorageManager;
    set(config: Partial<StorageManagerConfig>): void;
  }
  ...
  interface AssetManager {
    ...
    render(assets: Array<object | string>): HTMLElement;
  ...
  interface BlockManager {
    ...
    onLoad(): void;
    add(id: string, opts: BlockOptions | object): void;
  ...
  interface DeviceManager {
    getConfig(): BlockManagerConfig | object;
    onLoad(): void;
    add(id: string, width: string, opts?: { name?: string; height?: string; widthMedia?: string }): void;
    get(id: string): object;
    getAll(): Array<object>;
    getAllVisible(): Array<object>;
    remove(id: string): object;
